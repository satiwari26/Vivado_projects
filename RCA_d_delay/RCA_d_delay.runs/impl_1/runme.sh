...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/RCA_d_delay/RCA_d_delay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RC_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RC_adder.tcl -notrace
