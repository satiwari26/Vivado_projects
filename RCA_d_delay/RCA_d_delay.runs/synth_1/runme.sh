...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/RCA_d_delay/RCA_d_delay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RC_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RC_adder.tcl
