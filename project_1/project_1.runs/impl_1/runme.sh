...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log equationsModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source equationsModule.tcl -notrace
