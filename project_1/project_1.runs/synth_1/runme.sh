...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log equationsModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source equationsModule.tcl
