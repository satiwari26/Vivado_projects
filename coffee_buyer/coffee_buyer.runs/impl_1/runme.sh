...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/coffee_buyer/coffee_buyer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CoffeeBuyerModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CoffeeBuyerModule.tcl -notrace
