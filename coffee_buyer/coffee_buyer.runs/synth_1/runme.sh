...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/coffee_buyer/coffee_buyer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CoffeeBuyerModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CoffeeBuyerModule.tcl
