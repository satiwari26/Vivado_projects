...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/TruthTable/TruthTable.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TruthTable_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TruthTable_module.tcl
