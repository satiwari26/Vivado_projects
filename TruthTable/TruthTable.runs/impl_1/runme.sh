...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/TruthTable/TruthTable.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TruthTable_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TruthTable_module.tcl -notrace
