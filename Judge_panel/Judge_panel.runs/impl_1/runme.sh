...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/Judge_panel/Judge_panel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JudgePanel_Module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source JudgePanel_Module.tcl -notrace
