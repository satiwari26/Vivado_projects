...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/Judge_panel/Judge_panel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JudgePanel_Module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JudgePanel_Module.tcl
