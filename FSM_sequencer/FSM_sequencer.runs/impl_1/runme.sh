...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/FSM_sequencer/FSM_sequencer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sequencer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sequencer.tcl -notrace
