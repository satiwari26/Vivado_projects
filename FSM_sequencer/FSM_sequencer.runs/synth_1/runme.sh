...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/FSM_sequencer/FSM_sequencer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sequencer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sequencer.tcl
