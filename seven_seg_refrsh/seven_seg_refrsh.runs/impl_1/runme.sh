...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/seven_seg_refrsh/seven_seg_refrsh.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_seg_refresh.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seven_seg_refresh.tcl -notrace
