...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/multiplier/multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multi.tcl
