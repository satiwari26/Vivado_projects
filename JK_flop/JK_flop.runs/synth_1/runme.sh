...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/JK_flop/JK_flop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JKk_flop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JKk_flop.tcl
