...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/Minimal_truthT/Minimal_truthT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Minimal_tTable.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Minimal_tTable.tcl
