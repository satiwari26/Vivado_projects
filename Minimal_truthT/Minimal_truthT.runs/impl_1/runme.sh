...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/Minimal_truthT/Minimal_truthT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Minimal_tTable.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Minimal_tTable.tcl -notrace
