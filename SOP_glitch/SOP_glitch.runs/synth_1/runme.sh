...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/SOP_glitch/SOP_glitch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SOP_glitch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SOP_glitch.tcl
