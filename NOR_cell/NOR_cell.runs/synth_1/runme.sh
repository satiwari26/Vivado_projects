...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/NOR_cell/NOR_cell.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NOR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NOR.tcl
