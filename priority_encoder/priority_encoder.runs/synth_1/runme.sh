...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/priority_encoder/priority_encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pEncoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pEncoder.tcl
