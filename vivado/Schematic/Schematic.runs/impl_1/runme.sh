...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/vivado/Schematic/Schematic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SchematicModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SchematicModule.tcl -notrace
