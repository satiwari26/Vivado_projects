...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/vivado/Schematic/Schematic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SchematicModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SchematicModule.tcl
