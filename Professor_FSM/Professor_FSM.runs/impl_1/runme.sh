...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/Professor_FSM/Professor_FSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prof_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prof_FSM.tcl -notrace
