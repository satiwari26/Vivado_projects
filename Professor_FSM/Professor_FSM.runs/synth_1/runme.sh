...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/Professor_FSM/Professor_FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prof_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prof_FSM.tcl
