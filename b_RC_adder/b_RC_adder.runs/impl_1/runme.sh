...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/b_RC_adder/b_RC_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RC_add.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RC_add.tcl -notrace
