...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/reg_memory/reg_memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg_memory.tcl
