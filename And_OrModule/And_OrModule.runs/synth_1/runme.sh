...
HD_PWD='C:/Users/tiwar/OneDrive/Desktop/vivadoProjects/And_OrModule/And_OrModule.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Colab_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Colab_module.tcl
